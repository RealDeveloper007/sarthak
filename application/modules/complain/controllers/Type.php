...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage').' '.$this->lang->line('complain').' ' . $this->lang->line('type').' | ' . SMS);
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add'). ' ' . $this->lang->line('complain') .' '. $this->lang->line('type'). ' | ' . SMS);
        $this->layout->view('type/index', $this->data);
    }
    ...
    * ********************************************************** */
    public function edit($id = null) {       
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit'). ' ' .$this->lang->line('complain') .' '. $this->lang->line('type'). ' | ' . SMS);
        $this->layout->view('type/index', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_type_validation() {
        ...
        $this->form_validation->set_rules('type', $this->lang->line('complain').' '.$this->lang->line('type'), 'trim|required|callback_type');
    }
