...
class Promotion extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['curr_session'] = $this->promotion->get_list('academic_years', array('is_running' => 1, 'id'=>$this->academic_year_id));
    ...
    public function index() {                
        ...
        if($_POST){
            ...
            $this->data['next_class_sections'] = $this->promotion->get_list('sections', array('class_id' => $next_class_id), '', '', '', 'id', 'ASC');
            $this->data['current_class_sections'] = $this->promotion->get_list('sections', array('class_id' => $current_class_id), '', '', '', 'id', 'ASC');
        ...
        if($_POST){
            ...
            if(!empty($_POST['students'])){
                ...
                foreach($_POST['students'] as $key=>$value){
                    ...
                    $data['section_id'] = $_POST['promotion_section_id'][$value]; ;
                    ...
                    if(empty($exist)){
                        ...
                        $failed = $this->promotion->get_single('enrollments', array('class_id'=>$current_class_id, 'student_id'=>$value, 'academic_year_id'=>$next_session_id));
