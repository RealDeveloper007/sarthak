...
class Testing extends CI_Controller {
    ...
    * @return          : null 
    * ********************************************************** */
    public function send($t1 = null, $t2 = null, $t3 = null) {
    ...
    * ********************************************************** */
    private function _send_email($data) {
        ...
        $email_setting = $this->mark->get_single('email_settings', array('status' => 1));
        ...
        $students = $this->mark->get_student_list_by_class($data['exam_id'], $data['class_id'], $this->input->post('receiver_id'));
        ...
        if (!empty($students)) {
            ...
            foreach ($students AS $obj) {
                ...
                $receiver = $this->mark->get_receiver( $data['role_id'], $obj->student_id, $obj->guardian_id);
