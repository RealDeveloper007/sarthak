...
/* * *****************Web.php**********************************
 * @product name    : Gsss Sarthak School Management System Pro
 * @type            : Class
 * @class name      : Web
...
class Web extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $SettingDetails = $this->web->get_setting_details();

        $this->data['teacher'] = count($this->Teacher->get_teacher_list(1));
        $this->data['student'] = $SettingDetails->total_students;
        $this->data['total_events'] = $this->web->get_events();
     ...
     * @description     : Load "result listing" user interface                 
     *                    
     * @param           : null
     * @return          : null 
     * ********************************************************** */
     ...
     * @type            : Function
     * @function name   : result
     * @description     : Load "check result listing" user interface                 
     *                    
     * @param           : null
     * @return          : null 
     * ********************************************************** */
    public function checkResult()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if (isset($CheckResult->id)) {
                ...
                $this->session->set_flashdata('error', 'Sorry! details are mis matched');
                redirect('result/');
            }
        } else {
     ...
     * @description     : Load "our teachers listing" user interface                 
     *                    
     * @param           : null
     * @return          : null 
     * ********************************************************** */
    ...
    {
        $this->data['teachers'] = $this->Teacher->get_teacher_list(1);

        $this->layout->title('Our Teachers');
        $this->layout->view('our_teachers', $this->data);
    }

    /*****************Function teacher**********************************
     * @type            : Function
     * @function name   : our_students
     * @description     : Load "our_students listing" user interface                 
     *                    
     * @param           : null
     * @return          : null 
     * ********************************************************** */
    ...
    {
        $this->data['students'] = $this->Student->get_student_list(1);

        $this->layout->title('Our Students');
        $this->layout->view('our_students', $this->data);
    }

    /*****************Function teacher**********************************
     * @type            : Function
     * @function name   : our_courses
     * @description     : Load "our_courses listing" user interface                 
     *                    
     * @param           : null
     * @return          : null 
     * ********************************************************** */
    public function our_courses()
    {
        ...
        $this->data['settingDetails'] = $this->web->get_setting_details();

        $this->layout->title('Our Courses');
        $this->layout->view('our_courses', $this->data);
    }
    ...
    public function page($slug = null)
    {
        ...
        if ($slug == 'mandatory-public-disclosure') {
            $this->layout->view('mandatory_public_disclosure', $this->data);
        } else {
