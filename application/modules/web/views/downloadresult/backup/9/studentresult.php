	...
	<table cellspacing="0" cellpadding="5">
		...
		?>
			<tr>
				...
				<th align="center" ><?php if ($obj->subject_name == "IT" || $obj->subject_name == "B&W(407)" || $obj->subject_name == "Comp.Application") { ?>
						50
					<?php } else if ($obj->subject_name == "Home.Sc.") { ?>
						70
		...
		<tr>
			...
			<th colspan="2" class="bottom vertical" style="position:relative; text-transform:uppercase;"><?= $student_info->remarks ?><span></span></th>
		</tr>
		<!-- Blank Row -->
		<tr>
			<td colspan="8" class="no-border">&nbsp;</td>
