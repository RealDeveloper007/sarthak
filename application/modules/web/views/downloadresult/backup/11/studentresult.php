...
<body>
	<table cellspacing="0" cellpadding="5">
		...
		<tr>
			<th class="nowrap" align="left" rowspan="2">SUBJECT<br>CODE</th>
			<th class="nowrap" align="left" rowspan="2">SUBJECT<br>DETAILS</th>
			...
			<tr>
				...
				<th style="padding: 8px; border: 1px solid #000; text-align:center;" class="text_center">
					<?php if ($obj->subject_name == "IT" || $obj->subject_name == "B&W") { ?>
						60
					<?php } else if ($obj->subject_name == "Home.Sc." || $obj->subject_name == "Comp.Science" || $obj->subject_name == "Phy.Education" || $obj->subject_name == "CHEMISTRY" || $obj->subject_name == "PHYSICS" || $obj->subject_name == "BIOLOGY") { ?>
						70
				...
				<th align="center"><?=  $obj->total != 0 ? floor($obj->total) : '-' ?></th>
			</tr>
		<?php
			$ob = $ob + $obj->total;
			$tt = $tt + 100;
		...
		<tr>
			...
			<th class="right" align="center"><?= $student_info->result_status == 'P' ?  floor($ob) : '-' ?></th>
		</tr>
		<tr>
		...
		<tr>
			<th colspan="6" align="left" >Discipline</th>
			<td colspan="2" align="center" class="right"><?= $student_info->discipline ?></td>
		</tr>
		<!-- Blank Row -->
		<tr>
			<td colspan="8" class="no-border">&nbsp;</td>
		...
		<tr>
			...
			<th colspan="3" class="bottom vertical" style="position:relative; text-transform:uppercase;"><?= $student_info->remarks ?><span></span></th>
		</tr>
		<!-- Blank Row -->
		<tr>
			<td colspan="8" class="no-border">&nbsp;</td>
