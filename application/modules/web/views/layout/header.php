        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-8 col-sm-12 col-12 hta-left">
                    <div class="hta-box">
                        <p class="text">
                            <a href="<?= base_url('page/mandatory-public-disclosure') ?>"><img src="<?= base_url('assets/images/mandatory_public_disclosure') ?>/mandatory.gif"></a>
                        </p>
                    </div>
                ...
                <div class="col-lg-5 col-md-4 col-sm-12 col-12 hta-right text-right">
                    ...
                    <?php if (logged_in_user_id()) { ?>
                        ...
                        <div class="hta-box">
                            ...
                            <a class="text" href="<?php echo site_url('logout'); ?>"><?php echo $this->lang->line('logout'); ?></a>
                        </div>
                    <?php } else { ?>
                        <!-- <div class="hta-box">
                            <span class="icon"><i class="fas fa-sign-in-alt"></i></span>
                            <a class="text" href="<?php //echo site_url('login'); 
                    ...
                    <div class="menu">
                        <nav id="mobile_menu_active">
                            <ul id="menu">
                                ...
                                <li><a href="<?php echo site_url('about'); ?>"><?php echo $this->lang->line('about'); ?>S-</a></li>
                                ...
                                <li><a href="<?php echo site_url('result'); ?>">
                                        <img src="<?= base_url('assets/images/new_news.gif') ?>">
                                        <span><?php echo $this->lang->line('result').'/ Report Card' ?></span></a></li>
