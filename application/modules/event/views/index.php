...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa fa-calendar-check-o"></i><small> <?php echo $this->lang->line('manage_event'); ?><br><b style="color:red;"> Note : Please Upload images with equal or above dimensions (1024 * 768).<br> <a href="<?= site_url('events')?>" target="_blank">Click here to check preview on frontend</a></b></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_event_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'event', 'event')) { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="#tab_add_event" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('event'); ?></a> </li>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                    ...
                    <div class="tab-content">
                                        ...
                                        if (isset($events) && !empty($events)) { ?>
                                            <?php foreach ($events as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->event_from)); ?></td>
                                                    <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->event_to)); ?></td>
                                                    <td>
                                                        <?php if ($obj->image != '') { ?>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_event">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="title" id="title" value="<?php echo isset($event->title) ?  $event->title : ''; ?>" placeholder="<?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('title'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="role_id" id="role_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="0" <?php if ($event->role_id == 0) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('all'); ?></option>
                                                <?php foreach ($roles as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if ($event->role_id == $obj->id) {
                                                                                                echo 'selected="selected"';
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="event_place" id="event_place" value="<?php echo isset($event->event_place) ?  $event->event_place : ''; ?>" placeholder="<?php echo $this->lang->line('event_place'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('event_place'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="event_from" id="edit_event_from" value="<?php echo isset($event->event_from) ?  date($this->gsms_setting->sms_date_format, strtotime($event->event_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('from_date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('event_from'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="event_to" id="edit_event_to" value="<?php echo isset($event->event_to) ?  date($this->gsms_setting->sms_date_format, strtotime($event->event_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('to_date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('event_to'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"><?php echo $this->lang->line('note'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" name="note" id="note" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($event->note) ?  $event->note : ''; ?></textarea>
                                            <div class="help-block"><?php echo form_error('note'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1" <?php if ($event->is_view_on_web == 1) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="0" <?php if ($event->is_view_on_web == 0) {
                                                                        echo 'selected="selected"';
                        ...
                        <div class="tab-pane fade in active" id="tab_view_event">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <tbody>
                                    <tr>
                                        <th width="20%"><?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('title'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($event->image) { ?>
                                                <img src="<?php echo UPLOAD_PATH; ?>/event/<?php echo $event->image; ?>" alt="" style="width: 100%;" /><br /><br />
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <tr>
