...
class Decline extends MY_Controller {
    ...
    * ***********************************************************/
    public function index() {
        ...
        $this->data['applications'] = $this->decline->get_application_list($decline = 3);          
    ...
    * ********************************************************** */
    public function update($id = null) {
        ...
        $this->data['classes'] = $this->decline->get_list('classes', array('status' => 1), '','', '', 'id', 'ASC');
        
        $this->data['applications'] = $this->decline->get_application_list();      
