...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->layout->title($this->lang->line('manage').' '.$this->lang->line('leave').' ' . $this->lang->line('type').' | ' . SMS);
    ...
    * ********************************************************** */ 
    public function type() {
        if ($this->input->post('id') == '') {
            $type = $this->type->duplicate_check($this->input->post('role_id'), $this->input->post('type'));
            if ($type) {
            ...
            $type = $this->type->duplicate_check($this->input->post('role_id'), $this->input->post('type'), $this->input->post('id'));
            if ($type) {
                $this->form_validation->set_message('type', $this->lang->line('already_exist'));
                return FALSE;
            } else {
