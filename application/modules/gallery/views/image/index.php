...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa fa-image"></i><small> <?php echo $this->lang->line('manage_gallery_image'); ?> <br> <b style="color:red;"> Note : Please Upload min. 4 images with equal or above dimensions (700 * 525) in each Gallery Title.<br> <a href="<?= site_url('galleries')?>" target="_blank">Click here to check preview on frontend</a></b></small> </h3>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_image_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php 
                                    $count = 1; if(isset($images) && !empty($images)){ ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('gallery/image/edit/'.$image->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="caption"><?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('caption'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="caption"  id="caption" value="<?php echo isset($image->caption) ?  $image->caption : ''; ?>" placeholder="<?php echo $this->lang->line('image'); ?> <?php echo $this->lang->line('caption'); ?>" type="text">
                                        <div class="help-block"><?php echo form_error('caption'); ?></div>
                                    </div>
                                </div>
