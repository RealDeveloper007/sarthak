                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_holiday_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('holiday'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'announcement', 'holiday')) { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="#tab_add_holiday" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('holiday'); ?></a> </li>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                                        ...
                                        if (isset($holidays) && !empty($holidays)) { ?>
                                            <?php foreach ($holidays as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->date_from)); ?></td>
                                                    <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->date_to)); ?></td>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_holiday">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="title" id="title" value="<?php echo isset($holiday->title) ?  $holiday->title : ''; ?>" placeholder="<?php echo $this->lang->line('holiday'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('title'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="date_from" id="edit_date_from" value="<?php echo isset($holiday->date_from) ?  date($this->gsms_setting->sms_date_format, strtotime($holiday->date_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('from_date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date_from'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="date_to" id="edit_date_to" value="<?php echo isset($holiday->date_to) ?  date($this->gsms_setting->sms_date_format, strtotime($holiday->date_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('to_date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date_to'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1" <?php if ($holiday->is_view_on_web == 1) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="0" <?php if ($holiday->is_view_on_web == 0) {
                                                                        echo 'selected="selected"';
