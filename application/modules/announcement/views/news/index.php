...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bullhorn"></i><small> <?php echo $this->lang->line('manage_news'); ?><br><b style="color:red;"> Note : Please Upload images with equal or above dimensions (625 * 400).<br> <a href="<?= site_url('news')?>" target="_blank">Click here to check preview on frontend</a></b></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_news_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('news'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'announcement', 'news')) { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="#tab_add_news" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('news'); ?></a> </li>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_news">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="title" id="title" value="<?php echo isset($news->title) ?  $news->title : ''; ?>" placeholder="<?php echo $this->lang->line('news'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('title'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="date" id="edit_date" value="<?php echo isset($news->date) ?  date($this->gsms_setting->sms_date_format, strtotime($news->date)) : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="news"><?php echo $this->lang->line('news'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" name="news" id="edit_news" required="required" placeholder="<?php echo $this->lang->line('news'); ?>"><?php echo isset($news->news) ?  $news->news : ''; ?></textarea>
                                            <div class="help-block"><?php echo form_error('news'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1" <?php if ($news->is_view_on_web == 1) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="0" <?php if ($news->is_view_on_web == 0) {
                                                                        echo 'selected="selected"';
                        ...
                        <div class="tab-pane fade in active" id="tab_view_news">
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <tbody>
                                    <tr>
                                        <th width="20%"><?php echo $this->lang->line('news'); ?> <?php echo $this->lang->line('title'); ?></th>
                                        <td><?php echo $news->title; ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo $this->lang->line('date'); ?> </th>
                                        <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($news->date)); ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo $this->lang->line('image'); ?></th>
                                        <td>
