                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_notice_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'announcement', 'notice')) { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="#tab_add_notice" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('notice'); ?></a> </li>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_notice">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="title" id="title" value="<?php echo isset($notice->title) ?  $notice->title : ''; ?>" placeholder="<?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('title'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="date" id="edit_date" value="<?php echo isset($notice->date) ?  date($this->gsms_setting->sms_date_format, strtotime($notice->date)) : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="role_id" id="edit_role_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="0" <?php if ($notice->role_id == 0) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('all'); ?></option>
                                                <?php foreach ($roles as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if ($notice->role_id == $obj->id) {
                                                                                                echo 'selected="selected"';
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="is_view_on_web" id="is_view_on_web">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="1" <?php if ($notice->is_view_on_web == 1) {
                                                                        echo 'selected="selected"';
                                                                    } ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="0" <?php if ($notice->is_view_on_web == 0) {
                                                                        echo 'selected="selected"';
                        ...
                        <?php if (isset($detail)) { ?>
                            <div class="tab-pane fade in active" id="tab_view_notice">
                                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                            <th width="20%"><?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('title'); ?></th>
                                            <td><?php echo $notice->title; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('date'); ?> </th>
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($notice->date)); ?></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('notice_for'); ?></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('information'); ?></h4>
            </div>
