                         ...
                         <div class="tab-pane fade in active"id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_date"  id="registration_date" value="<?php echo isset($setting) ? date($this->gsms_setting->sms_date_format, strtotime($setting->registration_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('registration'); ?> <?php echo $this->lang->line('date'); ?> " required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="academic_year_id" >
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="total_students"><?php echo 'Total '.$this->lang->line('student'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="total_students"  id="total_students" value="<?php echo isset($setting) ? $setting->total_students : ''; ?>" placeholder="<?php echo 'Total '.$this->lang->line('student'); ?> " required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('total_students'); ?></div> 
                                        </div>
                                    </div>  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="front_logo"><?php echo $this->lang->line('frontend'); ?> <?php echo $this->lang->line('logo'); ?> <span style="font-size:10px;"> [Max W: 160px, Max H: 80px]</span></label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" >
                                        <div class="item form-group">
                                            <label for="favicon_icon"><?php echo $this->lang->line('favicon_icon'); ?> <span style="font-size:10px;"> [Max W: 16px, Max H: 16px]</span></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="favicon_icon" id="front_logo"  type="file">
                                            </div>
                                            <div class="help-block"><?php echo form_error('favicon_icon'); ?></div> 
                                            
                                            <?php if($setting->front_logo){ ?>
                                               <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $setting->favicon_icon; ?>" alt="" width="70" style="background: <?php echo $theme->color_code; ?>; padding: 5px;"/><br/><br/>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12"  style="display:none;">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="enable_online_admission" id="enable_online_admission" required="required">
                                                <option value="" >--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="0" <?php if(isset($setting) && $setting->enable_online_admission == 0){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                <option value="1" <?php if(isset($setting) && $setting->enable_online_admission == 1){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            </select>
                               ...
                               <div class="row">                             
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display:none;">
                                        <div class="item form-group">
                                            <label for="brand_logo"><?php echo $this->lang->line('brand'); ?> <?php echo $this->lang->line('logo'); ?> <span style="font-size:10px;"> [Max W: 70px, Max H: 70px]</span></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="brand_logo" id="brand_logo"  type="file">
                                            </div>
                                            <div class="help-block"><?php echo form_error('brand_logo'); ?></div> 
                                       
                                        <?php if($setting->brand_logo){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $setting->brand_logo; ?>" alt="" width="70" style="background: <?php echo $theme->color_code; ?>; padding: 5px;"/><br/><br/>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="display:none;">
                                        <div class="item form-group">
                                            <label for="logo"><?php echo $this->lang->line('admin_panel'); ?> <?php echo $this->lang->line('logo'); ?> <span style="font-size:10px;"> [Max W: 160px, Max H: 80px]</span></label>
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
