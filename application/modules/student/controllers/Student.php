...
class Student extends MY_Controller {
    ...
    * ********************************************************** */
    ...
    public function resizeImage($filename)
    {
             ...
             $config['source_image'] = $_SERVER['DOCUMENT_ROOT'] .'/assets/uploads/student-photo/' . $filename;
             $config['new_image'] = $_SERVER['DOCUMENT_ROOT'] .'/assets/uploads/student-photo/' . $filename;
