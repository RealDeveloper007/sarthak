...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa fa-desktop"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('frontend'); ?> <?php echo $this->lang->line('about'); ?> <br> <b style="color:red;"> Note : Please Upload images with equal or above dimensions (693 * 483) in below.</b></small></h3>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_about">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/about/edit/'), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="principle_text"><?php echo 'Principal Message'; ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="principle_text"  id="edit_principle_text" placeholder="<?php echo 'Principal Message'; ?>"><?php echo isset($setting->principle_text) ?  $setting->principle_text : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('principle_text'); ?></div>
                                    </div>
                                </div>  

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo 'Principal '.$this->lang->line('image'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" name="prev_principle_image" id="prev_principle_image" value="<?php echo $setting->principle_image; ?>" />
                                        <?php if($setting->principle_image){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/about/<?php echo $setting->principle_image; ?>" alt="" width="250" /><br/><br/>
                                        <?php } ?>
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control col-md-7 col-xs-12"  name="principle_image"  id="principle_image" type="file">
                                        </div>
                                        <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                        <div class="help-block"><?php echo form_error('principle_image'); ?></div>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="courses_text"><?php echo 'Courses Text'; ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="courses_text"  id="edit_courses_text" placeholder="<?php echo 'Courses Text'; ?>"><?php echo isset($setting->courses_text) ?  $setting->courses_text : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('courses_text'); ?></div>
                                    </div>
                                </div>  

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo 'Course '.$this->lang->line('image'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" name="prev_course_image" id="prev_course_image" value="<?php echo $setting->course_image; ?>" />
                                        <?php if($setting->course_image){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/about/<?php echo $setting->course_image; ?>" alt="" width="250" /><br/><br/>
                                        <?php } ?>
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control col-md-7 col-xs-12"  name="course_image"  id="course_image" type="file">
                                        </div>
                                        <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                        <div class="help-block"><?php echo form_error('course_image'); ?></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
 ...
 $('#edit_principle_text').jqte();
 $('#edit_courses_text').jqte();
