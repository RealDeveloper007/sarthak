...
class Payments extends CI_Controller {
    ...
    * ********************************************************** */
    private function _get_posted_payment_data() {
        ...
        if($this->input->post('payment_method') == 'paystack'){
        ...
        /*if($this->input->post('discount') > 0){            
            $data['amount'] = $data['amount'] - $this->input->post('discount');
            $discount = $this->input->post('discount');
            $invoice_id = $data['invoice_id'];
            $sql = "UPDATE invoices SET discount = discount+$discount  WHERE id = $invoice_id";
    	    $this->db->query($sql);
        }*/
    ...
    * ********************************************************** */
    public function payumoney_success() {
        ...
        //mail('''', 'PayUMoney', json_encode($_POST));
    ...
    * @return          : null 
    * ********************************************************** */
    public function paytest($p1 = null, $p2 = null, $p3 = null)
    {
        ...
        $this->paypal->add_field('item_name', 'Invoice - '.$data['note']);
    ...
    * ********************************************************** */
	...
	$dataSize = sizeof($decryptValues);
        ...
        mail('''', 'CCAVENUE Return', json_encode($rcvdString));
