<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_content">
                                ...
                                <style type="text/css">
                                	...
                                	img.print_content_img {
												...
												div#print-content {position: relative;}

											div#print-content table ,div#print-content table tr th,div#print-content table tr td {z-index: 999;position: relative;color: #000000;}
                              ...
                              <!--   <h4 style="text-align:center;">ACADEMIC SESSION: <?=$academic_year?><BR/><span style='text-align:center;'>REPORT CARD</span></h4>   -->
								...
								<table class="ctm_table1" style="width: 100%; text-align:left; border-collapse: collapse;
									...
									<tr style="padding: 8px; ">
										...
										<td style="padding: 8px" rowspan="5"> <div class="profil_photo" style="border: 1px solid #000;
																						...
																						"> 
											<img style="max-width:100%; height: 100%; width:100%;  object-fit:contain; " src="https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI=">  </div> </td>
									</tr>
		...
		margin-top:30px; text-align:left;">
									...
									<?php $ob=0;$tt=0;foreach($student_result as $obj) { ?>
    									<tr style="padding: 8px; border: 1px solid #000;">
		...
		margin-top:30px;">
							...
							<?php } ?>	
							   ...
							   <table style="width: 100%;">
                                ...
                                <input type="button" onclick="printDiv('print-content')" value="Print" class="btn btn-success pull-left"/>
                        </div>
                    </div>
                </div>         
            </div>
