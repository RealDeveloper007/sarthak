...
class Report_Model extends MY_Model
{
    ...
    public function get_single_student($academic_year_id = null, $class_id = null, $section_id = null, $student_id = null)
    {
        ...
        $this->db->select('E.roll_no, S.id, S.name, G.name as guardian_name, C.name as class_name');
    ...
    */
    ...
    public function get_result_info($id)
    {
        ...
        return $this->db->order_by('id', 'asc')->get('results')->result();
    }
