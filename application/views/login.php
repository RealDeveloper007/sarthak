...
<html lang="en">
    ...
    <body class="login">     
        ...
        <div class="login_wrapper">
            <section>
                <center>
                    <?php  if(isset($this->gsms_setting->front_logo) && !empty($this->gsms_setting->front_logo)){ ?>
                        <img  src="<?php echo UPLOAD_PATH.'logo/'.$this->gsms_setting->front_logo; ?>" style="max-width: 100px;" alt="">
                    <?php }else{ ?>
