...
<?php if($this->gsms_setting->theme_name == 'slate-gray'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'black'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'light-sea-green'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'medium-purple'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'navy-blue'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'rebecca-purple'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'red'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'dodger-blue'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'maroon'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'dark-orange'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'deep-pink'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'lime-green'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'jazzberry-jam'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'umber'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'trinidad'){ ?>
...
<?php }elseif($this->gsms_setting->theme_name == 'radical-red'){ ?>
