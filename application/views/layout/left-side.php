<div class="col-md-3 <?php echo $this->gsms_setting->enable_rtl ? 'right_col' : 'left_col'; ?>">
    <div class="<?php echo $this->gsms_setting->enable_rtl ? 'right_col' : 'left_col'; ?> scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dashboard'); ?>" class="site_title_">
                <span><?= $this->gsms_setting->school_name ?></span>
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                    ...
                    <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                        <li><a href="<?php echo site_url('student/index'); ?>"> <i class="fa fa-users"></i> <?php echo $this->lang->line('student'); ?></a></li>
                    <?php } ?> 
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') || 
                        ...
                        <li>
                            <!-- <a><i class="fa fa-group"></i>  -->
                            <?php //echo $this->lang->line('student'); ?> 
                        <!-- <span class="fa fa-chevron-down"></span></a> -->
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'students', 'type')){ ?>
                                ...
                                <?php } ?>  
                                <?php if(has_permission(VIEW, 'students', 'activity')){ ?>
                        ...
                        <li><a><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('report'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if($this->session->userdata('role_id') == TEACHER){ ?>
                                 <li><a href="<?php echo site_url('report/importresult'); ?>">Import <?php echo $this->lang->line('result'); ?></a></li>
                                <li><a href="<?php echo site_url('report/viewstudents'); ?>">View Students</a></li>
                                 <?php } else if($this->session->userdata('role_id') == ADMIN) { ?>
                                    <li><a href="<?php echo site_url('report/viewstudents'); ?>">View Students</a></li>
                                 <?php } ?>
                            </ul>
                            <!-- <ul class="nav child_menu">
