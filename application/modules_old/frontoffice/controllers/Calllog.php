...
class Calllog extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage').' ' . $this->lang->line('call_log').' | ' . SMS);
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add') .' '. $this->lang->line('call_log'). ' | ' . SMS);
        $this->layout->view('calllog/index', $this->data);
    }
    ...
    * ********************************************************** */
    public function edit($id = null) {       
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit') .' '. $this->lang->line('call_log'). ' | ' . SMS);
        $this->layout->view('calllog/index', $this->data);
    }
