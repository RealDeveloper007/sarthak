...
class Purpose extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage').' '.$this->lang->line('visitor').' ' . $this->lang->line('purpose').' | ' . SMS);
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add'). ' ' . $this->lang->line('visitor') .' '. $this->lang->line('purpose'). ' | ' . SMS);
        $this->layout->view('purpose/index', $this->data);
    }
    ...
    * ********************************************************** */
    public function edit($id = null) {       
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit'). ' ' .$this->lang->line('visitor') .' '. $this->lang->line('purpose'). ' | ' . SMS);
        $this->layout->view('purpose/index', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_purpose_validation() {
        ...
        $this->form_validation->set_rules('purpose', $this->lang->line('visitor').' '.$this->lang->line('purpose'), 'trim|required|callback_purpose');
    }
    ...
    * ********************************************************** */ 
    public function purpose() {
        if ($this->input->post('id') == '') {
            $purpose = $this->purpose->duplicate_check($this->input->post('purpose'));
            if ($purpose) {
            ...
            $purpose = $this->purpose->duplicate_check($this->input->post('purpose'), $this->input->post('id'));
            if ($purpose) {
                $this->form_validation->set_message('purpose', $this->lang->line('already_exist'));
                return FALSE;
            } else {
