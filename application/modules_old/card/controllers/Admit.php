    ...
    public function index(){
        ...
        $this->data['students'] = '';
         ...
         if ($_POST) {
            ...
            $this->data['subjects'] = $this->student->get_list('subjects', array('class_id'=>$class_id));
        ...
        $this->layout->title($this->lang->line('generate') .' ' . $this->lang->line('student').' ' . $this->lang->line('admit') .' ' . $this->lang->line('card') .' | ' . SMS);
