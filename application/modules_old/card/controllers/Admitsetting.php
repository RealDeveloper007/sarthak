...
class Admitsetting extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['setting'] = $this->setting->get_single('admit_card_settings', array('status'=>1));
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    create_log('Has been added admit card setting');                     
    ...
    public function edit($id = null) {   
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($updated) {                    
                    create_log('Has been updated admit card setting');                     
