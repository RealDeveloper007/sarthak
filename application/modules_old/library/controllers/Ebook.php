...
class Ebook extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->ebook->get_list('classes', array('status'=>1), '','', '', 'id', 'ASC');  
        $this->data['class_list'] = $this->ebook->get_list('classes', array('status'=>1), '','', '', 'id', 'ASC');
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {                    
                    ...
                    $class = $this->ebook->get_single('classes', array('id' => $data['class_id']));
    ...
    * ********************************************************** */
    ...
    public function delete($id = null) {
        ...
        if ($this->ebook->delete('ebooks', array('id' => $id))) {
            ...
            $class = $this->ebook->get_single('classes', array('id' => $ebook->class_id));
