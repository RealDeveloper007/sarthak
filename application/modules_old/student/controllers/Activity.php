...
class Activity extends MY_Controller {
    ...
    public function add() {
        ...
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add'). ' ' . $this->lang->line('activity'). ' | ' . SMS);
        $this->layout->view('activity/index', $this->data);
    }
    ...
    public function edit($id = null) {       
        ...
        $this->data['edit'] = TRUE;       
        $this->layout->title($this->lang->line('edit'). ' ' . $this->lang->line('activity'). ' | ' . SMS);
        $this->layout->view('activity/index', $this->data);
    }
     ...
     * @type            : Function
     * @function name   : view
     * @description     : Load user interface with specific activity data                 
     *                       
     * @param           : $activity_id integer value
     * @return          : null 
     * ********************************************************** */
    public function view( $activity_id = null ){
        ...
        $this->layout->title($this->lang->line('view'). ' ' . $this->lang->line('activity'). ' | ' . SMS);
        $this->layout->view('activity/index', $this->data);
    }
