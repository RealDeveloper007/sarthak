...
class Material extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->material->get_list('classes', array('status'=>1), '','', '', 'id', 'ASC');
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $class = $this->material->get_single('classes', array('id' => $data['class_id']));
   ...
   {  
    ...
    public function delete($id = null) {
        ...
        if ($this->material->delete('study_materials', array('id' => $id))) {   
            ...
            $class = $this->material->get_single('classes', array('id' => $material->class_id));
