        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $class = $this->syllabus->get_single('classes', array('id' => $data['class_id']));
   ...
   {  
    ...
    private function _upload_syllabus(){
        ...
        if ($syllabus != "") {
            if ($syllabus_type == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' || 
                ...
                $syllabus_path = 'syllabus-'.time() . '-sms.' . $extension;
    ...
    public function delete($id = null) {
        ...
        if ($this->syllabus->delete('syllabuses', array('id' => $id))) {   
            ...
            $class = $this->syllabus->get_single('classes', array('id' => $syllabus->class_id));
