...
class Frontend extends MY_Controller {
    ...
    * ********************************************************** */
    ...
    public function get_single_frontend(){
       ...
       $this->data['frontend'] = $this->frontend->get_single('pages', array('id' => $frontend_id));
    ...
    * ********************************************************** */
    private function _prepare_frontend_validation() {
        ...
        $this->form_validation->set_rules('page_title', $this->lang->line('page_title') . ' ' . $this->lang->line('title'), 'trim|required|callback_page_title');
    ...
    * @description     : Unique check for "frontend page title" data/value                  
    *                       
    * @param           : null
    ...
    * ********************************************************** */  
    public function page_title() {
        if ($this->input->post('id') == '') {
            $frontend = $this->frontend->duplicate_check($this->input->post('page_title'));
            if ($frontend) {
            ...
            $frontend = $this->frontend->duplicate_check($this->input->post('page_title'), $this->input->post('id'));
            if ($frontend) {
                $this->form_validation->set_message('page_title', $this->lang->line('already_exist'));
                return FALSE;
            } else {
