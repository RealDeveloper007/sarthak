...
class Slider extends MY_Controller {
    ...
    * ********************************************************** */
    ...
    public function get_single_slider(){
       ...
       $this->data['slider'] = $this->slider->get_single('sliders', array('id' => $slider_id));
    ...
    public function resizeImage($filename)
   {
            ...
            $config['source_image'] = $_SERVER['DOCUMENT_ROOT'] .'/assets/uploads/slider/' . $filename;
            $config['new_image'] = $_SERVER['DOCUMENT_ROOT'] .'/assets/uploads/slider/' . $filename;
