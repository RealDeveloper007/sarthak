...
class Image extends MY_Controller {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($updated) {
                    ...
                    create_log('Has been updated uploaded gallery image : '.$data['caption']);
    ...
    * ********************************************************** */
     ...
     * @type            : Function
     * @function name   : get_single_image
     * @description     : "Load single gallery image information" from database                  
    ...
    * ********************************************************** */
    ...
    public function resizeImage($filename)
    {
             ...
             $config['source_image'] = $_SERVER['DOCUMENT_ROOT'] .'/barara_school/assets/uploads/gallery/' . $filename;
             $config['new_image'] = $_SERVER['DOCUMENT_ROOT'] .'/barara_school/assets/uploads/gallery/' . $filename;
