...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa fa-image"></i><small> <?php echo $this->lang->line('manage_gallery_image'); ?>    <br>          <b style="color:red;"> Note : Please Upload min. 4 images with equal dimensions in each Gallery Title. <a href="<?= site_url('galleries')?>" target="_blank">Click here to check preview on frontend</a></b>
</small> </h3>
